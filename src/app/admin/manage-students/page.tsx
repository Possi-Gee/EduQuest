...
export default function AdminManageStudentsPage() {
  ...
  const handleRemoveStudent = async (studentId: string, studentName: string) => {
    if (confirm(`Are you sure you want to remove ${studentName}? This action is permanent.`)) {
      try {
  ...
  return (
    <div className="space-y-8 animate-in fade-in-50">
      <div className="flex items-center justify-between">
        ...
        {/* We can add a "Create Student" button here later if needed */}
      </div>

      <Card>
        <CardHeader>
          <CardTitle>All Students</CardTitle>
          <CardDescription>View and manage all students across the school.</CardDescription>
        </CardHeader>
        <CardContent>
          <Table>
            <TableHeader>
