...
const Certificate = React.forwardRef<HTMLDivElement, CertificateProps>(
  ({ userName, quizName, date, scorePercentage }, ref) => {
    return (
      ...
      >
        <div className="relative z-10 flex flex-col items-center text-center p-8 border-2 border-yellow-500/30 rounded-md">
          ...
          <GraduationCap className="w-16 h-16 text-yellow-500 my-6" />
          ...
          <p className="text-4xl font-semibold text-white my-4 underline decoration-yellow-500 underline-offset-8">{userName}</p>
          ...
          <p className="text-3xl font-bold text-white mt-2">{scorePercentage}%</p>
